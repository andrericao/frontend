...
export default function User({ user, removeUserFromList }){
	...
	//poderia ser User(props), porém trouxemos o objeto diretamente, atenção as chaves "{}".
	return (
		<div className={style.card}>
			<div className={style.imageContainer}>
				<img className={style.cardUserImage} 
			...
			<div className={style.buttonContainer}>
				...
				<button className={`${style.button} ${style.removeUserButton}`}
